  ...
  try {
    ...
    if (!stripeCustomerId) {
      const customer = await stripe.customers.create({
        ...
        name: userData.fullName || decoded.name || decoded.email || "Usuario Orion",
        metadata: {
          businessId,
          userId: decoded.uid
        }
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      success_url: `${process.env.APP_URL}/app.html#settings?checkout=success`,
      cancel_url: `${process.env.APP_URL}/app.html#settings?checkout=cancel`,
